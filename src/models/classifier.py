...
from src.functions.function import stfr_ferritin_index, cal_mentzer, diendihst
                ...
                if data.ferritin is None: pass
                    ...
                    if data.crp is None: pass
                        ...
                        if data.ferritin is None: pass
                            ...
                            if data.transferrin is not None or data.stfr is not None or data.ferritin is not None:

                                if data.transferrin < thres['transferrin'][0]:
                                ...
                                elif data.transferrin > thres["transferrin"][1]:
                                    # trả về ACD
                        ...
                        if data.transferrin is None: pass

                        elif data.transferrin < thres['transferrin'][0]:
                            # trả về IDA
                            diagnoses.append(labels[1])
